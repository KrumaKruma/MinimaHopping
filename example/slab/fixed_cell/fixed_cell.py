...
def main():
    ...
    # Set the calculator.
    initial_configuration.calc = EMT()

    with Minimahopping(initial_configuration, mdmin=3, fixed_cell_simulation = True,verbose_output=True, T0=500, dt0=0.01, use_MPI=False) as mh:
        mh(totalsteps=50)
