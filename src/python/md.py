...
class MD():
    def __init__(self, atoms, cell_atoms=None, dt=0.01, n_max=3, verbose=True):
    ...
    def _update_lattice_positions(self):
        ...
        self._cell_atoms.positions = self._cell_atoms.positions + self._dt * self._cell_atoms.velocities + 0.5 * self._dt * self._dt * (self._lattice_force / self._cell_atoms.masses)
    ...
    def _update_lattice_velocities(self,):
        ...
        self._cell_atoms.velocities = self._cell_atoms.velocities + 0.5 * self._dt * ((self._lattice_force + _lattice_force_new) / self._cell_atoms.masses)
